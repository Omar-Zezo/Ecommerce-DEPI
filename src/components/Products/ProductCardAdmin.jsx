...
const ProductCardAdmin = ({ product, cardSize }) => {
  return (
    ...
    >
      ...
      <button className="w-1/2 py-2 flex items-center justify-center bg-red-600 text-white rounded-lg text-lg font-medium">Delete</button>
    </div>
